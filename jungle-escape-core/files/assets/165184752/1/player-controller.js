...
PlayerController.prototype.sendInputToServer = function () {
  ...
  this.networkEntity.send("input", {
    ...
    animState: {
      isRunning: this.entity.isRunning,
      isJumping: this.entity.isJumping,
      isAttacking: this.entity.isAttacking,
      isHit: this.entity.isHit,
      isVictory: this.entity.isVictory,
      isVow: this.entity.isVow,
    },
    modelRotation: {
      x: modelRotation.x,
      y: modelRotation.y,
